						...
						<div class="row">
							<div class="col-sm-8">
								...
								<div class="row">
									...
									<div class="tab-pane fade in " id="jog-tab">
								...
								<div class="smart-form">
									...
									<div class="tab-pane fade in active" id="touch-tab">
										<div class="touch-container">
											...
											<img class="bed-image" src="/assets/plugin/fab_laser/img/hybrid_bed_v2_small.jpg" style="opacity: 0.8; filter: alpha(opacity=80)";>
